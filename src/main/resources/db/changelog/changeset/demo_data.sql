insert into cars(brand,number,color,price) values('VOLKSWAGEN','1234KP-7','GREEN',45032);
insert into cars(brand,number,color,price) values('HYUNDAI','0046KP-4','BLACK',50000);
insert into cars(brand,number,color,price) values('VOLVO','2222KH-7','BLUE',60000);
